...
class Contrastive(tf.keras.Model):
    ...
    def train_step(self, data):
        ...
        ds_one = tf.ensure_shape(ds_one, (None, 30, 64))
        ds_two = tf.ensure_shape(ds_two, (None, 30, 64))

        print("ds_one type:", type(ds_one))
        print("ds_one shape:", getattr(ds_one, "shape", None))
        print("ds_two type:", type(ds_two))
        print("ds_two shape:", getattr(ds_two, "shape", None))
