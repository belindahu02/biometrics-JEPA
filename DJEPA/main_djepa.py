...
from engine.djepa import evaluate, train_one_epoch
...
def get_args_parser():
    ...
    # Model parameters
    parser.add_argument('--model', default='djepa_large', choices=["djepa_base", "djepa_large", "djepa_huge"], type=str, metavar='MODEL',
...
def main(args):
    ...
    # define the vae and djepa model
